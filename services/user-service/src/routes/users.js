...
router.get('/profile', authMiddleware, async (req, res) => {
  try {
    logger.log('Fetching user profile', { userId: req.user.id });
...
router.put('/profile', authMiddleware, async (req, res) => {
  try {
    ...
    logger.log('Updating user profile', { userId: req.user.id });
...
router.get('/addresses', authMiddleware, async (req, res) => {
  try {
    logger.log('Fetching user addresses', { userId: req.user.id });
